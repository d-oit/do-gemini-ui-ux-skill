...
Call log:
  ...
  - waiting for fonts to load...
  - fonts loaded
  - 1673 pixels (ratio 0.01 of all image pixels) are different.
  - waiting 500ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 2221 pixels (ratio 0.01 of all image pixels) are different.
  - waiting 1000ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 1229 pixels (ratio 0.01 of all image pixels) are different.
  - waiting 1000ms before taking screenshot
